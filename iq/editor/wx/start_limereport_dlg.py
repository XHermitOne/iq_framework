...
###########################################################################
## Class iqStartLimeReportEditorDialogProto
###########################################################################

class iqStartLimeReportEditorDialogProto ( wx.Dialog ):

	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = _(u"LimeReport"), pos = wx.DefaultPosition, size = wx.Size( 483,369 ), style = wx.DEFAULT_DIALOG_STYLE )
		...
		self.new_button = wx.Button( self, wx.ID_ANY, _(u"New LimeReport project"), wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.open_button = wx.Button( self, wx.ID_ANY, _(u"Open LimeReport project"), wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		convert_choiceChoices = [ _(u"PDF"), _(u"SVG") ]

...
"""
Directory property editor class module.
"""
...
class iqDirPropertyEditor(wx.propgrid.PGTextCtrlAndButtonEditor):
    """
    ...
    def OnEvent(self, propgrid, property, ctrl, event):
        ...
        if eventType == wx.wxEVT_COMMAND_BUTTON_CLICKED:
            value = wxdlg_func.getDirDlg(parent=None, title=u'Select directory')

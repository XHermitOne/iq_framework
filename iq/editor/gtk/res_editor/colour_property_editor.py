...
class iqColourPropertyEditor(gtk_handler.iqGtkHandler,
                             property_editor_proto.iqPropertyEditorProto):
    """
    Colour property editor class.
    """
    def __init__(self, label='', value=None, choices=None, default=None, *args, **kwargs):
        self.glade_filename = os.path.join(os.path.dirname(__file__), 'colour_property_editor.glade')
    ...
    def setValue(self, value):
        ...
        if isinstance(value, str):
            color = gi.repository.Gtk.Color(value)
            self.getGtkObject('property_colorbutton').set_color(color)
            color_str = color.to_string()
            self.getGtkObject('property_entry').set_text(color_str)

    def getValue(self):
        """
        Get color value.
        """
        color = self.getGtkObject('property_colorbutton').get_color()
    ...
    def onPropertyColorSet(self, widget):
        """
        Set color handler.
        """

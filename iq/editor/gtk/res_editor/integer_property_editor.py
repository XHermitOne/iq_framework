...
class iqIntegerPropertyEditor(gtk_handler.iqGtkHandler,
                             property_editor_proto.iqPropertyEditorProto):
    """
    Integer property editor class.
    """
    def __init__(self, label='', value=None, choices=None, default=None, *args, **kwargs):
        self.glade_filename = os.path.join(os.path.dirname(__file__), 'integer_property_editor.glade')
        ...
        if value:
            self.getGtkObject('property_spinbutton').set_value(value)

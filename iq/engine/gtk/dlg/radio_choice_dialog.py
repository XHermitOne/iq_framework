...
class iqRadioChoiceDialog(gtk_handler.iqGtkHandler):
    """
    Radio choice dialog class.
    """
    def __init__(self, *args, **kwargs):
        self.glade_filename = os.path.join(os.path.dirname(__file__), 'radio_choice_dialog.glade')
        gtk_handler.iqGtkHandler.__init__(self, glade_filename=self.glade_filename,
                                          top_object_name='radio_choice_dialog',  
                                          *args, **kwargs)
    ...
    def initControls(self, title=None, label=None, choices=()):
        """

...
class iqCheckboxDialog(gtk_handler.iqGtkHandler):
    """
    Select CheckBox items dialog.
    """
    def __init__(self, *args, **kwargs):
        self.glade_filename = os.path.join(os.path.dirname(__file__), 'checkbox_dialog.glade')
        gtk_handler.iqGtkHandler.__init__(self, glade_filename=self.glade_filename,
                                          top_object_name='checkbox_dialog',  
                                          *args, **kwargs)
    ...
    def initControls(self, title=None, label=None, choices=(), do_fit_dlg=True,
                     defaults=()):
        """

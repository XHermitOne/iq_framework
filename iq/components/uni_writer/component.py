...
"""
UniWriter controller component.
"""
...
class iqUniWriterController(uni_writer_controller.iqUniWriterControllerProto, object.iqObject):
    """
    UniWriter controller component.
    """
    def __init__(self, parent=None, resource=None, context=None, *args, **kwargs):
        ...
        uni_writer_controller.iqUniWriterControllerProto.__init__(self,
                                                                  host=self.getHost(),
                                                                  port=self.getPort(),
    ...
    def printConnectionParam(self):
        ...
        """
        log_func.info(u'UniWriter <%s>. Communication parameters:' % self.getName())
...
COMPONENT = iqUniWriterController

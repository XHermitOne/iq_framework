...
###########################################################################
## Class iqViewSQLQueryDialogProto
###########################################################################

class iqViewSQLQueryDialogProto ( wx.Dialog ):

	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = _(u"Viewing SQL query results"), pos = wx.DefaultPosition, size = wx.Size( 856,619 ), style = wx.DEFAULT_DIALOG_STYLE )
		...
		self.m_staticText2 = wx.StaticText( self.sql_panel, wx.ID_ANY, _(u"SQL:"), wx.DefaultPosition, wx.DefaultSize, 0 )

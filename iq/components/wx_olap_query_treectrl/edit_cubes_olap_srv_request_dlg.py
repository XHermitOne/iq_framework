...
"""
Edit OLAP server request dialog.
"""
...
class iqEditCubesOLAPSrvRequestDialog(edit_cubes_olap_srv_request_dlg_proto.iqEditCubesOLAPSrvRequestDlgProto):
    """
    Edit OLAP server request dialog.
    """
    def __init__(self, *args, **kwargs):
        ...
        Constructor.
        """
        edit_cubes_olap_srv_request_dlg_proto.iqEditCubesOLAPSrvRequestDlgProto.__init__(self, *args, **kwargs)
...
def editCubesOLAPServerRequestDlg(parent=None, olap_srv=None, olap_srv_request=None):
    """
    Open edit OLAP server request dialog.
    ...
    """
    if olap_srv is None:
        log_func.warning(u'OLAP server object not defined for edit request')
        return None
    ...
    try:
        dlg = iqEditCubesOLAPSrvRequestDialog(parent=parent)
        ...
        log_func.fatal(u'Error edit OLAP server request')
    return None

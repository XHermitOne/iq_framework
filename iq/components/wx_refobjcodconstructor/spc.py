...
"""
Wx RefObjCodConstructor specification module.
"""
...
COMPONENT_TYPE = 'iqWxRefObjCodConstructor'

WXREFOBJCODCONSTRUCTOR_STYLE = {
}

WXREFOBJCODCONSTRUCTOR_SPC = {
    'name': 'default',
    'type': COMPONENT_TYPE,
    'description': '',
    'activate': True,
...
SPC = WXREFOBJCODCONSTRUCTOR_SPC

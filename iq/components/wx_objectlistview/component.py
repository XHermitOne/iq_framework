...
class iqWxObjectListView(ObjectListView.ObjectListView,
                         component.iqWxWidget):
    """
    Wx object list view component.
    """
    def __init__(self, parent=None, resource=None, context=None, *args, **kwargs):
        ...
        ObjectListView.ObjectListView.__init__(self, parent=parent, id=wx.NewId(),
                                               style=self.getStyle(),

...
"""
Wx RefObjChoice specification module.
"""
...
COMPONENT_TYPE = 'iqWxRefObjChoice'

# WXREFOBJCHOICE_STYLE = {
...
WXREFOBJCHOICE_SPC = {
    ...
    '__doc__': 'iq.components.wx_refobjchoice.html',
    '__content__': (),
    '__edit__': {
        # 'style': {
        #     'editor': property_editor_id.FLAG_EDITOR,
        #     'choices': WXREFOBJCHOICE_STYLE,
        # },
    ...
    '__help__': {
        ...
        'on_select': u'Choice change event handler',
    },
}

SPC = WXREFOBJCHOICE_SPC

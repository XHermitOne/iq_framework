...
"""
Wx RefObjMultipleChoiceComboCtrl specification module.
"""
...
COMPONENT_TYPE = 'iqWxRefObjMultipleChoiceComboCtrl'

WXREFOBJMULTIPLECHOICECOMBOCTRL_STYLE = {
...
WXREFOBJMULTIPLECHOICECOMBOCTRL_SPC = {
    'name': 'default',
    'type': COMPONENT_TYPE,
    'description': '',
    'activate': True,
    ...
    '__doc__': 'iq.components.wx_refobjmultiplechoicecomboctrl.html',
    '__content__': (),
    '__edit__': {
        'style': {
            'editor': property_editor_id.FLAG_EDITOR,
            'choices': WXREFOBJMULTIPLECHOICECOMBOCTRL_STYLE,
        },
...
SPC = WXREFOBJMULTIPLECHOICECOMBOCTRL_SPC
